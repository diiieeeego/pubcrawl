...
export default function Header() {
    return (
        <div className="w-full h-screen bg-[url('/herobg.webp')] bg-cover bg-no-repeat bg-center">
            <section className=" max-w-6xl md:w-6xl mx-auto grid grid-cols-12 gap-4 pt-64">
                <div className="px-5 col-span-12 sm:col-span-8">
                    <h1 className="text-5xl sm:text-7xl font-bold w-full sm:text-start">THE BEST <br /> PARTY CREW <br /> <span className="font-light text-4xl sm:text-6xl">IN ZADAR</span></h1>
