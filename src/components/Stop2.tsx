...
export default function Stop2(){
    return(
        ...
        <div className="max-w-6xl pt-16 h-screen ms-auto bg-[url('/stop2.jpg')] bg-cover bg-no-repeat bg-center p-32 pt-40 opacity-80">
            ...
            <h1 className="text-4xl md:text-8xl font-bold text-neutral-50 my-8 xs:mt-0 text-shadow">
              FREE <br/> DRINK
            </h1>
            <div>
            <h1 className="text-3xl md:text-5xl font-bold text-red-500/80 my-8 xs:mt-0 text-shadow">
              ... AAAND 
            </h1>
            <h2 className="text-3xl md:text-5xl font-bold text-neutral-50 my-4 text-shadow">20% <br /> DISCOUNT</h2>
            </div>
            </div>
            <p className="w-2/3 text-xl mt-8 text-shadow">
