...
export default function Schedule() {
  ...
  return (
    <div className="max-w-md w-full p-6 bg-white shadow-xl rounded-2xl space-y-6 shadow-lg">
      <h2 className="text-xl font-semibold text-gray-800">Reserve your spot</h2>
