    ...
    <>
      <div className="w-full h-screen bg-[url('/herobg.webp')] flex items-center justify-start">
        <section className="max-w-6xl mx-auto">
          <div className="px-5 flex flex-col items-start gap-10 w-full">
            <h1 className="text-5xl text-start sm:text-7xl font-bold w-full sm:text-center">THE BEST <br /> PARTY CREW <br /> <span className="font-light">IN ZADAR</span></h1>
